...
const steps = [
  ...
  },
  {
    ...
    icon: Shield,
    description:
      '식품위생법에 따른 정식 수입 절차를 철저히 준수합니다. 수입식품판매업 신고 완료 업체로서, 모든 통관 서류를 정확하게 구비하고 대한민국 식약처의 검역 절차를 거칩니다. 원산지증명서, 검역증명서 등 수입 관련 서류를 확보하여 요청 시 제공해 드립니다.',
  },
  {
    number: 3,
    title: '보관 & 로트 관리',
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-blue-50 rounded-lg p-8 md:p-12 text-center">
            ...
            <div className="space-y-4 text-gray-600 mb-8">
              ...
              <p>
                필요한 서류는 요청 범위 내에서 투명하게 제공해 드립니다.
              </p>
            </div>
            <Link href="/contact">
